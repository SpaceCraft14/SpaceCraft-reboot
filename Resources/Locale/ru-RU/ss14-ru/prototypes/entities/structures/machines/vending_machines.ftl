...
ent-VendingMachineSustenance = тюремный торгомат
    .desc = Торговый автомат, который реализует продукты питания, как того требует раздел 47-C Соглашения об этическом обращении с заключенными QL.
...
ent-VendingMachineKink = КинкоМат
    .desc = Розовый торговый автомат с интересным содержанием.
