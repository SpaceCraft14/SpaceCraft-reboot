...
ent-PenCentcom = ручка Центком
    .desc = В стремлении не отстать от "мощи" бюрократической машины Cybersun, Qillu создала реплику их кибер-ручки в своём корпоративном стиле. Кажется, они забыли, что являются партнёрами.
